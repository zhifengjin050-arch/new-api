...
const PriceRow = ({ label, value, suffix }) => (
                ...
                <div className='mb-4 p-3 rounded-xl bg-gray-50 dark:bg-gray-800'>
                  {priceData.isDynamicPricing ? (
                    ...
                    <div className='space-y-2.5'>
                      <PriceRow label={t('输入价格')} value={priceData.inputPrice} suffix={`/ 1${priceData.unitLabel} Tokens`} />
                      <PriceRow label={t('补全价格')} value={priceData.completionPrice} suffix={`/ 1${priceData.unitLabel} Tokens`} />
                      {priceData.cachePrice && (
                        <PriceRow label={t('缓存读取价格')} value={priceData.cachePrice} suffix={`/ 1${priceData.unitLabel} Tokens`} />
                      )}
                      {priceData.createCachePrice && (
                        <PriceRow label={t('缓存创建价格')} value={priceData.createCachePrice} suffix={`/ 1${priceData.unitLabel} Tokens`} />
                      )}
                    </div>
                  ) : (
                    <div className='text-xs text-gray-600'>
                      {t('价格')}: {priceData.price} / {t('次')}
                    </div>
                  )}
                </div>
